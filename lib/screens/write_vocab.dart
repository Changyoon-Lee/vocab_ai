import 'package:autovocab/activity_indicator/activity_indicator.dart';
import 'package:autovocab/api/make_sentense.dart';
import 'package:flutter/material.dart'
    hide Ink; // mlkit에서 Ink 클래스를 사용하기 때문에 숨김처리
...
class _DigitalInkViewState extends State<DigitalInkView> {
  ...
  String _recognizedText = ''; // 인식된 text
            ...
            if (_recognizedText.isNotEmpty)
              Column(
                children: [
                  ...
                  FutureBuilder(
                    future: make_sentence(_recognizedText),
                      ...
                      if (snapshot.connectionState == ConnectionState.done) {
                        if (snapshot.hasError) {
                          return Padding(
                            ...
                            child: Text(
                              'hoho: ${snapshot.error}', // 에러명을 텍스트에 뿌려줌
                          ...
                          return Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              snapshot.data.toString(), // 에러명을 텍스트에 뿌려줌
